...
#ifndef PORT_PROXY_PORTPROXY_TASK_HPP
#define PORT_PROXY_PORTPROXY_TASK_HPP
...
namespace port_proxy {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','port_proxy::Task')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Task(std::string const& name = "port_proxy::Task", TaskCore::TaskState initial_state = Stopped);
